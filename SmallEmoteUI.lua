...
-- 1) File setup for persistence
local presetFile = "AariesAim_CustomPresets.txt"
local presetNames = {}
...
local function savePresetNames()
    writefile(presetFile, HttpService:JSONEncode(presetNames))
end
...
MadeByLabel.Position = UDim2.new(0.5, 0, -0.16, 0) -- Same X as SearchBar, higher Y
