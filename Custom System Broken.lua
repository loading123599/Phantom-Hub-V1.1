if game.CoreGui:FindFirstChild("SysBroker") then
  game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Poison's System Broken",Text = "GUI Already loaded, rejoin to re-execute",Duration = 5;})
  return
end
local version = 2
--VARIABLES
...
local function ChangeToggleColor(Button)
  ...
  if led.ImageColor3 == Color3.fromRGB(0, 0, 0) 

    led.ImageColor3 = Color3.fromRGB(138, 43, 226)
  else
